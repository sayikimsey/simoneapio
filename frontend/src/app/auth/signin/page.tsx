...
// import { FaMicrosoft } from "react-icons/fa"; // NEU: Import des Microsoft Icons für SSO
...
//     const googleAuthUrl = `${API_BASE_URL}/auth/google`; // Konstruiert die URL zum Starten des Google OAuth-Flows im Backend.
//     window.location.href = googleAuthUrl; // Leitet den Browser des Benutzers zur generierten URL um.
//   };

//   /**
//    * -------------------------------------------------------------------
//    * ✅ Funktion: handleMicrosoftSignIn (NEU)
//    * Leitet den Benutzer zur Microsoft Azure AD Anmeldeseite um.
//    * Dies initiiert den SAML 2.0 Authentifizierungsablauf.
//    * -------------------------------------------------------------------
//    */
//   const handleMicrosoftSignIn = () => {
//     // Die URL leitet zum Node.js Proxy weiter, der wiederum an den Java-Dienst proxt.
//     const azureAdAuthUrl = `${API_BASE_URL}/simone/saml2/authenticate/azure-ad`; // Korrekte Proxy-Route für Azure AD SAML
//     window.location.href = azureAdAuthUrl; // Leitet den Browser des Benutzers zur generierten URL um.
//   };
...
//             <div className="mt-6">
//               {" "}
//               {/* UNCOMMENTED: Outer div for social logins */}
...
//                   Google
//                 </button>
//                 {/* NEU: Microsoft Azure AD SSO Button */}
//                 <button
//                   onClick={handleMicrosoftSignIn} // Ruft die Microsoft-Anmeldefunktion auf.
//                   type="button"
//                   aria-label="Mit Microsoft Azure AD anmelden" // Zugänglichkeitslabel.
//                   className="inline-flex w-full justify-center rounded-md border border-[var(--border-color)] bg-[var(--color-input-background)] py-2 px-4 shadow-sm hover:bg-[var(--color-hover-background)] focus:outline-none focus:ring-2 focus:ring-[var(--color-accent)] focus:ring-offset-2 text-sm font-medium text-[var(--color-text-primary)]"
//                 >
//                   <FaMicrosoft
...
const SAML_START_URL = process.env.NEXT_PUBLIC_SAML_REDIRECT_URL!;
...
function SignInContent() {
  ...
  const handleMicrosoftSignIn = () => {
    ...
    window.location.href = SAML_START_URL;
  };
